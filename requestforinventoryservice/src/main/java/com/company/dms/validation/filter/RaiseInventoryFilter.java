...
/**
 * A filter that handles raising inventory requests based on specified criteria.
 */
public class RaiseInventoryFilter implements Filter {
    private static final Logger logger = LoggerFactory.getLogger(RaiseInventoryFilter.class);
    /**
    ...
    /**
     * The main filtering logic for raising inventory requests.
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        logger.info("Enter Filter {}", RaiseInventoryFilter.class.getName());
        HttpServletRequest request=(HttpServletRequest)servletRequest;
        HttpServletResponse response=(HttpServletResponse) servletResponse;
        FilterHelper filterHelper = new FilterHelper();
        filterHelper.helperForEachFilterForPost(request, response, AllFieldValidation.fieldValidation(), InventoryRequestInputDto.class, filterChain);
    }
    /**
