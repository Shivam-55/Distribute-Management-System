...
public class DecodeText {
    ...
    private static final String SECRET_KEY = "adkhsjflandljkbasdbasndllkasjsjk";
    ...
    public static String decryptText(String value) {
        ...
        try {
            ...
            throw new NoSuchAlgorithmFoundException("Error generating key: "+ e);
        }
        ...
        try {
            ...
            throw new NoSuchAlgorithmFoundException("Error decrypting text"+ e.getMessage());
        }
    }
}
