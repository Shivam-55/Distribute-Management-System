...
public class RemoveUserFilter implements Filter {
    private static final Logger logger = LoggerFactory.getLogger(RemoveUserFilter.class);
    /**
    ...
    /**
     * Performs the filtering logic for remove user requests.
     *
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        logger.info("Enter Filter {}", RemoveUserFilter.class.getName());
