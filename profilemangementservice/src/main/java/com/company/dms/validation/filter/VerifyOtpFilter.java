...
public class VerifyOtpFilter implements Filter {
    private static final Logger logger = LoggerFactory.getLogger(VerifyOtpFilter.class);
    /**
    ...
    /**
     * Performs the filtering logic for verify otp requests.
     *
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        logger.info("Enter Filter {}", VerifyOtpFilter.class.getName());
        HttpServletRequest request=(HttpServletRequest)servletRequest;
        HttpServletResponse response=(HttpServletResponse) servletResponse;
        FilterHelper filterHelper = new FilterHelper();
        filterHelper.helperForEachFilterForPost(request, response, AllFieldValidation.fieldValidation(), OtpDto.class, filterChain);
    }
    /**
