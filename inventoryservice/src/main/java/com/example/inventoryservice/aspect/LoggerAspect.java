...
import com.example.inventoryservice.utility.logger.CustomLogger;
...
public class LoggerAspect {
     ...
     */
    @Pointcut("@within(com.example.inventoryservice.utility.logger.LoggableClass)")
     ...
     */
    @Pointcut("@annotation(com.example.inventoryservice.utility.logger.LoggableMethod)")
     ...
     */
    @Pointcut("@annotation(com.example.inventoryservice.utility.logger.NotLoggableMethod)")
