package com.example.inventoryservice.utility;

import com.example.inventoryservice.exception.NoSuchAlgorithmFoundException;
...
public class DecodeText {
    ...
    public static String decryptText(String value){
        ...
        try {
            ...
            throw new NoSuchAlgorithmFoundException(e.getLocalizedMessage());
        }
