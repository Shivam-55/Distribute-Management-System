package com.company.micro.security.aspect;
...
import com.company.micro.security.util.logger.CustomLogger;
...
public class LoggerAspect {
     ...
     */
    @Pointcut("@within(com.impetus.micro.security.util.logger.LoggableClass)")
     ...
     */
    @Pointcut("@annotation(com.impetus.micro.security.util.logger.LoggableMethod)")
     ...
     */
    @Pointcut("@annotation(com.impetus.micro.security.util.logger.NotLoggableMethod)")
